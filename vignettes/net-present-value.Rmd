...
With this dynamic pricing change, the NPV has reduced by `r total(pv3) - total(pv2)`, from `r total(pv2)` to `r total(pv3)`. The corresponding base R code is shown below.
